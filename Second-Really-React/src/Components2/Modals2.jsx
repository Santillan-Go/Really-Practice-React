...
import { Modal2Portal } from './Modal2Portal';
...
const [portal,isopenPortal,isClose]=useModal2(false)
...
<button onClick={isopenPortal} className='open-modal2'>Modal Portal</button>
<Modal2Portal    open={portal}  isClose={isClose}>
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5_f-3Npwnj40B6u8O8WmcX8swxRqUS8ncQg&usqp=CAU" alt="img" />
